...
PermissionGroups.defaults = {
    ...
    admin = {
        ...
        level = 2,
        permissions = { "admin.all", "admin.kick", "admin.ban", "admin.healrevive", "admin.vehicle", "character.delete", "job.set" }
    },
    moderator = {
...
function PermissionGroups.getAllGroups() return PermissionGroups.defaults end
function PermissionGroups.getGroupLevel(groupName) return PermissionGroups.getGroupInfo(groupName).level end
function PermissionGroups.getGroupPermissions(groupName) return PermissionGroups.getGroupInfo(groupName).permissions or {} end
